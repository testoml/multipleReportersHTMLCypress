...
Create a new file cypress/support called directoryReport.js who allow create and delete report folders
```sh
...
![App Screenshot](https://drive.google.com/file/d/14O4uR8j4m7MjMzRSMrak4qKQof4Q1ix)
...
```sh
 npm test
```
Report are generated and the screenshot is displayed according to failed test case.
![App Screenshot](https://drive.google.com/file/d/14O4uR8j4m7MjMzRSMrak4qKQof4Q1ix)
